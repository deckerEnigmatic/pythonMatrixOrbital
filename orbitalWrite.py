...
#write_display(addr,word)
#sys.exit()

#let = '0'
#print find_letter(let)


#bus = smbus.SMBus(1)
#bus.write_byte_data(0x28,0x24,0x00)
#clear led
#bus.write_byte_data(0x28,0xFE,0x58)
#bus.write_byte(0x28,find_letter("B"))
#bus.write_byte(0x28,0x52)
#bus.write_byte(0x28,0x49)
#bus.write_byte(0x28,0x41)
#bus.write_byte(0x28,0x4E)
